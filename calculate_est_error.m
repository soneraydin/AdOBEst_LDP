function L = calculate_est_error(theta, G, loss_type)

% L = calculate_est_error(theta, G, loss_type)
% 
% This function computes the estimation error for a given loss function.
